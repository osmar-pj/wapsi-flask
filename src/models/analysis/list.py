...
def getWeekAnalysis(serie, name, start, end):
    ...
    if len(df_final) == 0:
        ...
        if len(df_analysis) == 0:
            ...
            bars_dict = dbars.to_dict('records')
            voladuras_dict = df_voladuras.to_dict('records')
            turnos_dict = df_turn.to_dict('records')

            data = {
                'mean': mean,
                'data_final': final_dict,
                'bars': bars_dict,
                'data_voladuras': voladuras_dict,
                'data_turnos': turnos_dict,
                'promedios': promedios
            }
            
    return data

def getMonthAnalysis(serie, name, nro_month):
    ...
    if len(df_final) == 0:
        ...
        if len(df_analysis) == 0:
            ...
            vol_dia = int(df_voladuras['DIA'].sum())
            vol_noche = int(df_voladuras['NOCHE'].sum())
            vol_total = int(df_voladuras['index'].count())
            ...
            if len(df_turn) == 0:
                data = {
                    ...
                    'promedios': {},
                    'data_voladuras': df_voladuras.to_dict('records'),
                    'data_turnos': []
                }
            else:
